...
-- Made the default tab stop and shift width to 4 spaces instead of its usual 8
vim.opt.ts = 4
vim.opt.sw = 4
...
-- Sets the default terminal to powershell
vim.opt.shell = 'powershell'
vim.opt.shellcmdflag = '-NoLogo -NoProfile -ExecutionPolicy RemoteSigned -Command'
vim.opt.shellquote = ''
vim.opt.shellxquote = ''

-- Make a small window on bottom for terminal
...
-- Adding a keymap to go to the explorer using leader pv
